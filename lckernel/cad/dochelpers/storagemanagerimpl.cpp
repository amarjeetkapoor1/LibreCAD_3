...
StorageManagerImpl::StorageManagerImpl() : StorageManager() {
    ...
    _layers.insert(std::make_pair("0", std::make_shared<Layer>("0", LineWidth(1.0), MetaColor(1., 1., 1.))));
    _layers.insert(std::make_pair("1", std::make_shared<Layer>("1", LineWidth(1.0), MetaColor(1., 1., 1.))));
    _layers.insert(std::make_pair("2", std::make_shared<Layer>("2", LineWidth(1.0), MetaColor(1., 1., 1.))));
    _layers.insert(std::make_pair("3", std::make_shared<Layer>("3", LineWidth(1.0), MetaColor(1., 1., 1.))));
    _layers.insert(std::make_pair("4", std::make_shared<Layer>("4", LineWidth(1.0), MetaColor(1., 1., 1.))));
    _layers.insert(std::make_pair("5", std::make_shared<Layer>("5", LineWidth(1.0), MetaColor(1., 1., 1.))));
}
